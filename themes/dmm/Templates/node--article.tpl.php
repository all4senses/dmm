...
<?php endif; ?>
      ...
      <?php 
        if (!$user->uid) {
          ...
          echo '<div class="login-to-comment"><a class="ctools-use-modal ctools-modal-ctools-ajax-register-style" href="ajax_register/login/nojs?destination=' . ltrim(str_replace('#comment-form', '', $_SERVER['REQUEST_URI']), '/') . '#comment-form' .'">Log</a></div>';
