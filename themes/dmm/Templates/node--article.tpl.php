...
<?php endif; ?>
      ...
      <?php 
        if (!$user->uid) {
          ...
          echo '<div class="login-to-comment"><a class="ctools-use-modal ctools-modal-modal-popup-medium-dmm" href="/modal_forms/nojs/login?destination=http://dommoejmechty.com.ua' . url('node/' . $node->nid, array('fragment' => 'comment-form')) . '">Modal Login</a></div>';
